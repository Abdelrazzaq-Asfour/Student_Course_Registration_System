...
<body>
    ...
    <section class="boxs">
            <h2>About BrightStart Academy</h2>
            <p>
                BrightStart Academy is a leading educational institution dedicated to providing high-quality learning experiences for students of all ages. 
                Our mission is to empower learners with the skills and knowledge they need to succeed in today's dynamic world.
            </p>
            <p>
                Established in 2020, BrightStart Academy offers a diverse range of courses, workshops, and programs designed to inspire creativity, foster 
                critical thinking, and build strong foundations for academic and professional success.
            </p>
